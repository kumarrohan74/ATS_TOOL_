    ...
    <div className="bg-slate-50 w-screen min-h-screen p-6">
      <div class="flex flex-wrap w-full">
        <div class="w-full rounded-lg overflow-hidden shadow-lg border border-gray-200 m-2 my-4 p-6 flex">
          ...
          <div class="ml-auto">
            <p class="text-gray-600 text-lg"><strong><MailIcon /></strong> {list.email}</p>
            <p class="text-gray-600 text-lg"><strong><LocalPhoneIcon /></strong> {list.phone_number}</p>
            <p class="text-gray-600 text-lg"><strong><LocationOnIcon /></strong> {list.location}</p>
            <p class="text-gray-600 text-lg"><strong><PictureAsPdfIcon /><a href={list.resume_url} target="_blank" rel="noopener noreferrer" className="text-indigo-600 underline ml-1">View Resume</a></strong> </p>
          </div>
        </div>
      </div>
